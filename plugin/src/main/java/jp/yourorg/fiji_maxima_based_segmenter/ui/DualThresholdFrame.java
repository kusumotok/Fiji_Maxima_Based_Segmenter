...
import jp.yourorg.fiji_maxima_based_segmenter.util.IJLog;
...
public class DualThresholdFrame extends PlugInFrame {
    ...
    private void buildLayout() {
        ...
        Panel maximaPanel = new Panel(new FlowLayout(FlowLayout.LEFT));
        maximaPanel.add(new Label("Find Maxima tol:"));
        maximaPanel.add(findMaximaField);
        maximaPanel.add(findMaximaBar);
